...
echo "baseurl=$URL/redhat/$RHELPATH/$LABEL/$RELEASE/${RELEASE}${VERSION^}/$ARCH/baseos/" >> $RHN_SOURCE
...
echo "baseurl=$URL/redhat/$RHELPATH/$LABEL/$RELEASE/${RELEASE}${VERSION^}/$ARCH/supplementary/" >> $RHN_SOURCE
echo "gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release" >> $RHN_SOURCE
...
echo "baseurl=$URL/redhat/$RHELPATH/$LABEL/$RELEASE/${RELEASE}${VERSION^}/$ARCH/appstream/" >> $RHN_SOURCE
echo "gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release" >> $RHN_SOURCE
echo "skip_if_unavailable=1" >> $RHN_SOURCE
...
echo "baseurl=$URL/redhat/$RHELPATH/$LABEL/$RELEASE/${RELEASE}${VERSION^}/$ARCH/HighAvailability/" >> $RHN_SOURCE
echo "gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release" >> $RHN_SOURCE
echo "skip_if_unavailable=1" >> $RHN_SOURCE
...
echo "baseurl=$URL/redhat/$RHELPATH/$LABEL/$RELEASE/${RELEASE}${VERSION^}/$ARCH/ResilientStorage/" >> $RHN_SOURCE
echo "gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release" >> $RHN_SOURCE
echo "skip_if_unavailable=1" >> $RHN_SOURCE
...
echo "baseurl=$URL/redhat/$RHELPATH/$LABEL/$RELEASE/${RELEASE}${VERSION^}/$ARCH/CRB/" >> $RHN_SOURCE
echo "gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release" >> $RHN_SOURCE
echo "skip_if_unavailable=1" >> $RHN_SOURCE
